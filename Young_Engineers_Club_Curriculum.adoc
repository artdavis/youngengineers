...
== Workshop {counter:workshop}: Battling Bristle Bots
Battling Robots design, build and tournament

include::workshops/battling_bristle_bots.adoc[]


= Rocket Club
Additional references:

* https://www.nasa.gov/audience/foreducators/rocketry/lessonplans/

== Rocketry {counter:rockets}: Rocketry Fundamentals
include::workshops//rocket_club/rocketry_fundamentals.adoc[]

== Rocketry {counter:rockets}: First Rocket Build
include::workshops//rocket_club/first_rocket_build.adoc[]

== Rocketry {counter:rockets}: First Rocket Launch
include::workshops//rocket_club/first_rocket_launch.adoc[]

= Untested Workshops

== Workshop {counter:workshop}: Structural Engineering
include::workshops/structural_engineering.adoc[]
